...
const DEMO_PRODUCTS: Record<string, {
  ...
  "1": { brand: "Nestlé", name: "Nescafé Gold Blend",  category: "alimentation", size: "200g", ean: "3800059908943", description: "Lot surplus certifié. Café soluble haut de gamme.", stock_units: 183, retail_price: 8.90,  expiry_date: new Date(Date.now() + 110 * 86400000).toISOString().split("T")[0], warehouse: "Paris CDG", moq: 1, current_price: 3.99  },
  "2": { brand: "Nestlé", name: "KitKat Chunky Box",   category: "alimentation", size: "×24 barres", ean: "", description: "Chocolat au lait KitKat Chunky, lot de 24.", stock_units: 44,  retail_price: 11.90, expiry_date: new Date(Date.now() + 6   * 86400000).toISOString().split("T")[0], warehouse: "Lyon Part-Dieu", moq: 6, current_price: 5.49  },
  "3": { brand: "Nestlé", name: "Maggi Bouillon ×72",  category: "alimentation", size: "×72 cubes", ean: "", description: "Cubes de bouillon de poulet Maggi.", stock_units: 320, retail_price: 3.80,  expiry_date: new Date(Date.now() + 35  * 86400000).toISOString().split("T")[0], warehouse: "Paris CDG", moq: 1, current_price: 1.59  },
  "4": { brand: "Nestlé", name: "Nespresso Blend 12",  category: "boissons",     size: "×50 pods", ean: "", description: "Capsules Nespresso compatibles Blend Intenso.", stock_units: 12,  retail_price: 14.50, expiry_date: new Date(Date.now() + 12  * 86400000).toISOString().split("T")[0], warehouse: "Bruxelles", moq: 1, current_price: 7.20  },
  "5": { brand: "Nestlé", name: "Milo Activ-Go 400g",  category: "boissons",     size: "400g", ean: "", description: "Boisson maltée chocolatée Milo, riche en énergie.", stock_units: 560, retail_price: 8.20,  expiry_date: new Date(Date.now() + 55  * 86400000).toISOString().split("T")[0], warehouse: "Marseille", moq: 12, current_price: 4.10  },
};
